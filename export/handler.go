...
type Handler interface {
	// Handler handles the Telemetry produced by auto-instrumentation.
	//
	// Telemetry passed to the handler is assumed to be the responsibility of
	// the Handler once it is passed. Any error handling needs to be done by
	// the Handler itself.
	//
