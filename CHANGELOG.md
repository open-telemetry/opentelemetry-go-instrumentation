...
- Add gRPC status code attribute for client spans (`rpc.grpc.status_code`) and support `go.opentelemetry.io/otel@v1.30.0` ([#1044](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/1044))
