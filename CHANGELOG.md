...
- Cache offsets for `go.opentelemetry.io/otel` `v1.45.0`. ([#3734](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3734))
- Cache offsets for `go.opentelemetry.io/otel` `v1.46.0`. ([#3829](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3829))
...
- Cache offsets for `golang.org/x/net` `0.57.0`. ([#3627](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3627))
...
- Cache offsets for `google.golang.org/grpc` `1.82.0`. ([#3589](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3589))
- Cache offsets for `google.golang.org/grpc` `1.82.1`. ([#3652](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3652))
- Cache offsets for `google.golang.org/grpc` `1.82.2`. ([#3829](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3829))
...
- Cache offsets for `google.golang.org/grpc` `1.83.0`. ([#3725](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3725))
- Cache offsets for `google.golang.org/grpc` `1.83.2`. ([#3829](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3829))
- Cache offsets for `google.golang.org/grpc` `1.84.0-dev`. ([#3645](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3645))
...
- Cache offsets for Go `1.25.12`. ([#3620](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3620))
...
- Cache offsets for Go `1.26.5`. ([#3620](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3620))
...
- Cache offsets for Go `1.24.8`. ([#2905](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/2905))
- Cache offsets for Go `1.25.2`. ([#2905](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/2905))
- Cache offsets for `golang.org/x/net` `0.46.0`. ([#2915](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/2915))
...
- Cache offsets for `golang.org/x/net` `0.47.0`. ([#3015](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3015))
...
- Cache offsets for `golang.org/x/net` `0.48.0`. ([#3105](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3105))
- Cache offsets for `google.golang.org/grpc` `1.79.0-dev`. ([#3122](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3122))
- Cache offsets for `google.golang.org/grpc` `1.78.0`. ([#3165](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3165))
- Cache offsets for `golang.org/x/net` `0.49.0`. ([#3198](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3198))
- Cache offsets for `github.com/segmentio/kafka-go` `0.4.50`. ([#3213](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3213))
- Cache offsets for Go `1.24.12`. ([#3213](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3213))
...
- Cache offsets for `golang.org/x/net` `0.50.0`. ([#3297](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3297))
- Cache offsets for `google.golang.org/grpc` `1.79.0`. ([#3303](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3303))
- Cache offsets for Go `1.26.0`. ([#3303](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3303))
- Cache offsets for `google.golang.org/grpc` `1.79.1`. ([#3319](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3319))
- Cache offsets for `golang.org/x/net` `0.51.0`. ([#3351](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3351))
- Cache offsets for `go.opentelemetry.io/otel` `v1.41.0`. ([#3361](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3361))
- Cache offsets for `go.opentelemetry.io/otel` `v1.42.0`. ([#3365](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3365))
- Cache offsets for `golang.org/x/net` `0.52.0`. ([#3365](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3365))
- Cache offsets for `google.golang.org/grpc` `1.79.2`. ([#3365](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3365))
- Cache offsets for `google.golang.org/grpc` `1.80.0-dev`. ([#3365](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3365))
- Cache offsets for `google.golang.org/grpc` `1.81.0-dev`. ([#3365](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3365))
- Cache offsets for Go `1.25.8`. ([#3365](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3365))
...
- Cache offsets for `google.golang.org/grpc` `1.79.3`. ([#3402](https://github.com/open-telemetry/opentelemetry-go-instrumentation/pull/3402))
