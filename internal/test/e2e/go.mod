...
require (
	...
	google.golang.org/grpc/examples v0.0.0-20250812064150-19c720f666f3
)
...
require (
	...
	go.opentelemetry.io/contrib/detectors/autodetect v0.0.0-20250808185858-b96d3af0fafd // indirect
	go.opentelemetry.io/contrib/detectors/aws/ec2/v2 v2.0.0-20250807162148-4933b0a71839 // indirect
