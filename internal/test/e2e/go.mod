...
require (
	...
	google.golang.org/grpc/examples fa0d65832080
)
...
require (
	...
	go.opentelemetry.io/contrib/detectors/autodetect v0.0.0-20250818225315-bdf710db7736 // indirect
	go.opentelemetry.io/contrib/detectors/aws/ec2/v2 v2.0.0-20250818225315-bdf710db7736 // indirect
