...
require (
	...
	google.golang.org/grpc/examples 5ed7cf6a5cf1
)
...
require (
	...
	go.opentelemetry.io/contrib/detectors/autodetect v0.0.0-20250820231659-c61faea0dbde // indirect
	go.opentelemetry.io/contrib/detectors/aws/ec2/v2 v2.0.0-20250820215116-24cc7c9c1fa8 // indirect
