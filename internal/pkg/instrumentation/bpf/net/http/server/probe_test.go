...
func TestProbeConvertEvent(t *testing.T) {
	...
	got := i.convertEvent(&Event{
		...
		// "localhost:8080"
		RemoteAddr: [32]byte{0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x68, 0x6f, 0x73, 0x74, 0x3a, 0x38, 0x30, 0x38, 0x30, 0x0},
		// "localhost:8080"
		Host: [32]byte{0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x68, 0x6f, 0x73, 0x74, 0x3a, 0x38, 0x30, 0x38, 0x30, 0x0},
		// "HTTP/1.1"
